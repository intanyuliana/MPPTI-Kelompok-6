...
if(isset($_POST['Simpan'])){
    ...
    $sql = "INSERT INTO kategori (kategori, denda) VALUES ('$kategori', '$denda')";
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div class="navbar-form navbar-left">
					 <p style="font-size: 32px; margin-top: 7px;">Tambah Kategori</p>
				</div>
				<div id="navbar-menu">
				...
				<div class="container-fluid">
					...
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Form Tambah Kategori</h3>
							<div class="right">
						...
						<div class="panel-body">
							<form action="tambah_kategori.php" method="POST">
						      	...
						      	<div class="form-group">
						            ...
						            <input type="text" name="denda" class="form-control" placeholder="Masukkan Nominal" required="">
						        </div>
